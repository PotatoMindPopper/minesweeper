...
Bestandsnaam/File name:                         stapel.h
...
class StapelEntry{
  public:
    StapelEntry();
    StapelEntry* vorigeStapel;
    koffiebord* bordStapel;
};

class Stapel{
  public:
    Stapel(){
      ingangStapel = nullptr;
    }//constructor
    StapelEntry* ingangStapel;
    void zetOpStapel(koffiebord* bordStapel);
    koffiebord* pakVanStapel();
};
*/